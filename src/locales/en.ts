...
export default {
  ...
  settings: {
    ...
    diag: {
      ...
      enableHelp: 'When off, Agents run no automatic traceroute.',
      ...
      consecutiveFailuresHelp: 'Consecutive failed checks a target must accumulate before its Agent traces the path (1–20). Matches the fault confirmation threshold by default, so the trace runs as the fault becomes real.',
