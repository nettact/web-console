...
export default {
  ...
  spform: {
    ...
    secAgents: 'Nodes',
    agentsHint:
      'Published nodes show their display name and online state only — never the hostname, platform, version or resource usage. A node with no display name appears as “Node 1”, “Node 2”.',
    showAgentView: 'Show the node list',
    noAgents: 'This site has no agents yet.',
    noAgentsPicked: 'No nodes selected — the page’s node list will be empty.',
